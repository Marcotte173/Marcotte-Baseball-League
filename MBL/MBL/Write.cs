...
public class Write
{
    ...
    internal static void Display()
    {
        ...
        Line(120, 3,  "[A] "+Color.POSITION+"Catcher     "+Color.RESET+" -   " + Color.PLAYER + Return.InField().catcher.name);
        Line(120, 4,  "[B] "+Color.POSITION+"First Base  "+Color.RESET+" -   " + Color.PLAYER + Return.InField().first.name);
        Line(120, 5,  "[C] "+Color.POSITION+"Second Base "+Color.RESET+" -   " + Color.PLAYER + Return.InField().second.name);
        Line(120, 6,  "[D] "+Color.POSITION+"Third Base  "+Color.RESET+" -   " + Color.PLAYER + Return.InField().third.name);
        Line(120, 7,  "[E] "+Color.POSITION+"Short Stop  "+Color.RESET+" -   " + Color.PLAYER + Return.InField().shortStop.name);
        Line(120, 8,  "[F] "+Color.POSITION+"Left Field  "+Color.RESET+" -   " + Color.PLAYER + Return.InField().lf.name);
        Line(120, 9,  "[G] "+Color.POSITION+"Center Field"+Color.RESET+" -   " + Color.PLAYER + Return.InField().cf.name);
        Line(120, 10, "[H] "+Color.POSITION+"Right Field "+Color.RESET+" -   " + Color.PLAYER + Return.InField().rf.name);
        Line(120, 12, "[P] "+Color.POSITION+"Pitcher     "+Color.RESET+" -   " + Color.PLAYER + Return.InField().pitcher.name);
        Line(120, 14, "Pitch Count      -   " + Return.InField().pitcher.pitchCount[Engine.week]);
